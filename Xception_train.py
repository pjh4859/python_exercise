...
import os
import numpy as np
from Xception_20191109 import Xception
...
model = Xception()# 위의 공장에서 모델을 만들어 낸 것. 이게 없으면 모델이 없는것.
...
torch.save(weight_dict1, "C:\\Users\\PARKJaehee\\Desktop\\Codes\\python_code\\Xception_model1.pt")
