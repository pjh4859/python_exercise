...
import os
import numpy as np
from residual_network_20191019 import ResidualNetwork
...
dataset = MNIST(root='C:\\Users\\PARKJaehee\\Desktop\\Codes\\python_code\\datasets', download=True, transform=ToTensor(), train=True)
data_loader = DataLoader(dataset=dataset, batch_size=32, shuffle=True)

model = ResidualNetwork(pre_activation=True)# 위의 공장에서 모델을 만들어 낸 것. 이게 없으면 모델이 없는것.
...
torch.save(weight_dict1, "C:\\Users\\PARKJaehee\\Desktop\\Codes\\python_code\\Regidual_model7.pt")
